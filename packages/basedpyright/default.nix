# https://github.com/NixOS/nixpkgs/pull/308503
{
  lib,
  nix-update-script,
  buildNpmPackage,
  ...
  src = fetchFromGitHub {
    ...
    repo = "basedpyright";
    rev = "v${version}";
    hash = "sha256-jz2V7tfRIQYyNCS+vxI7QgGuKKSbk4wGHApWujOA8Qg=";
  };
  ...
  pyright-internal = buildNpmPackage {
    ...
    npmDepsHash = "sha256-/63wU+iTs2Go/6csgNxUdYqYe9WPoFrGVDORz1kcph0=";
    dontNpmBuild = true;
...
in
  buildNpmPackage rec {
    ...
    npmDepsHash = "sha256-rizaeUNYAjUs8QuLDai/BZc7NxxdvsbVEwcZJ4n1xvo=";
