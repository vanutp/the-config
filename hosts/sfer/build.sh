...
cp servers/"$SERVER_NAME"/system/network.nix $SFER/network.nix
git add $SFER/hardware-configuration.nix $SFER/disko.nix $SFER/network.nix
...
rm $SFER/hardware-configuration.nix $SFER/disko.nix $SFER/network.nix
