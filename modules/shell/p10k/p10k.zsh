# Generated by Powerlevel10k configuration wizard on 2024-04-08 at 22:11 CEST.
...
() {
  ...
  #######################[ direnv: direnv status (https://direnv.net/) ]########################
  # Direnv color.
  typeset -g POWERLEVEL9K_DIRENV_FOREGROUND=74
  typeset -g POWERLEVEL9K_DIRENV_ICON='󱄅'
  # Custom icon.
